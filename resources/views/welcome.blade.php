    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <img class="logo" src="{{ url('/images/main-logo.svg') }}" alt="infyom logo " width="200px"
                    height="">
            </div>
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    ...
                    <div class="p-6">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                                    <a href="https://18nsj.tokyo/" class="underline text-gray-900 dark:text-white">
                                        中央会場公式サイト
                                    </a>
                                </div>
                            </div>
                        ...
                        {{-- <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                                    <a href="pp" class="underline text-gray-900 dark:text-white" target="_blank">
                                        個人情報保護
                                    </a>
                                </div>
                            </div>
                ...
                <div>
                    <div class="uk-card uk-card-primary uk-card-body">
                        ...
                        <ul class="uk-list">
                            <li>2022/07/04 奉仕スタッフの三次申込を開始しました</li>
                            <li>2022/06/21 奉仕スタッフの二次申込を終了しました</li>
                            <li>2022/06/01 奉仕スタッフの二次申込を開始しました(6/20(月) 23:59まで)</li>
                            <li>2022/06/01 日向野営場の募集を終了しました</li>
                            <li>2022/06/01 配属部署の決定通知を送信しました</li>
                            <li>2022/05/11 奉仕スタッフの一次申込を終了しました</li>
                            <li>2022/04/29 派遣隊のデータ登録を開始しました</li>
                            <li>2022/04/08 奉仕スタッフの申込を開始しました</li>
                        </ul>
                    </div>
                </div>
